...
Once the `conda-forge` channel has been enabled, `findent` can be installed with:

```
conda install findent
```

It is possible to list all of the versions of `findent` available on your platform with:
